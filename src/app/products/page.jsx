...
function Products() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold text-right mb-10">محصولات</h1>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
        {dairyProducts.map((product, index) => (
          <div key={index} className='flex flex-col justify-center items-center'>
            <div
              // key={index}
              className="bg-slate-200 rounded-full shadow-md overflow-visible h-[300] w-[300] flex items-center justify-center relative cursor-pointer hover:scale-105 transition-transform duration-300 ease-in-out"
            >
              <Image
                src={product.image}
