  ...
  return (
    <div className="flex flex-row flex-1 items-center justify-center">
      <div className="flex flex-row flex-1 justify-center items-center px-10">
        ...
        <div className="flex items-center justify-center bg-red-300 aspect-square w-[10%] border">
          exp
        </div>
        <div className="flex items-center justify-center bg-red-300 aspect-square w-[10%] border">
          exp
        </div>
        {/* <div className="flex items-center justify-center bg-red-300 aspect-square w-[10%]">
          exp
        </div> */}
        <div className="flex items-center justify-center bg-red-300 aspect-square w-[10%] border">
          exp
